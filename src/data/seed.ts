...
export const defaultSkills: Skill[] = [
  // Systems & Support
  { id: 's1', name: 'Windows OS Administration', level: 95, category: 'Systems & Support' },
  { id: 's2', name: 'Microsoft 365 & Office', level: 90, category: 'Systems & Support' },
  { id: 's3', name: 'Active Directory', level: 80, category: 'Systems & Support' },
  { id: 's4', name: 'Helpdesk / Ticketing Systems', level: 92, category: 'Systems & Support' },
  { id: 's5', name: 'IT Asset Management', level: 85, category: 'Systems & Support' },
  // Networking
  { id: 'n1', name: 'TCP/IP, DNS, DHCP', level: 88, category: 'Networking' },
  { id: 'n2', name: 'Router & Switch Config', level: 82, category: 'Networking' },
  { id: 'n3', name: 'Wi-Fi Setup & Troubleshooting', level: 90, category: 'Networking' },
  { id: 'n4', name: 'MikroTik (Winbox)', level: 78, category: 'Networking' },
  { id: 'n5', name: 'LAN/WAN Setup', level: 85, category: 'Networking' },
  // Database & Reporting
  { id: 'd1', name: 'SQL Queries & Reporting', level: 80, category: 'Database & Reporting' },
  { id: 'd2', name: 'MySQL / SQL Server', level: 78, category: 'Database & Reporting' },
  { id: 'd3', name: 'Database Backup & Restore', level: 85, category: 'Database & Reporting' },
  { id: 'd4', name: 'Core Banking System Support', level: 88, category: 'Database & Reporting' },
  // Tools & Security
  { id: 't1', name: 'AnyDesk / TeamViewer', level: 95, category: 'Tools & Security' },
  { id: 't2', name: 'VMware / VirtualBox', level: 75, category: 'Tools & Security' },
  { id: 't3', name: 'PowerShell / CMD Scripting', level: 72, category: 'Tools & Security' },
  { id: 't4', name: 'Antivirus & System Security', level: 88, category: 'Tools & Security' },
  { id: 't5', name: 'Data Backup & Recovery', level: 85, category: 'Tools & Security' },
];
...
export const defaultProjects: Project[] = [
  {
    ...
    tech: ['React', 'NestJS', 'Prisma', 'PostgreSQL', 'TypeScript', 'Socket.io'],
    highlights: [
  ...
  },
  {
    ...
    tech: ['React', 'Recharts', 'SQL Server', 'REST API', 'TypeScript'],
    highlights: [
  ...
  },
  {
    ...
    tech: ['React', 'Markdown', 'Node.js', 'SQLite', 'Full-text Search'],
    highlights: [
  ...
  },
  {
    ...
    tech: ['React', 'Vite', 'TypeScript', 'CSS Variables', 'localStorage'],
    highlights: [
